  ...
  <div class="model-part">
    ...
    <div class="part-content">
      <div class="content-item" v-loading="jyjl.loading">
        <div class="con-title">
          <h4>经验交流</h4>
          <nuxt-link to="/list?type=jyjl" target="_blank" class="more" v-if="jyjl.total > 2">
      ...
      <div class="content-item number" v-loading="fsbk.loading">
        <div class="con-title">
          <h4>复试备考</h4>
          <nuxt-link to="/list?type=fsbk" target="_blank" class="more" v-if="fsbk.total > 2">
            更多<i class="el-icon-plus"></i>
          </nuxt-link>
        </div>
        <ul class="con-list">
      ...
      <div class="content-item cate" v-loading="tjzn.loading">
        <div class="con-title">
          <h4>调剂指南</h4>
          <nuxt-link to="/list?type=tjzn" target="_blank" class="more" v-if="tjzn.total > 2">
            更多<i class="el-icon-plus"></i>
          </nuxt-link>
        </div>
        <ul class="con-list">
